"""Django settings for the property management API."""
...
# Postgres is the default. Set DB_ENGINE=sqlite to run without a Postgres
# instance around (handy for a quick local check or in CI).
if os.getenv("DB_ENGINE", "postgres") == "sqlite":
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "hmlet_pms"),
